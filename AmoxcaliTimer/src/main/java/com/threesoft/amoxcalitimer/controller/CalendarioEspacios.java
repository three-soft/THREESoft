...
@ManagedBean
@ViewScoped
public class CalendarioEspacios extends AceptarSolicitudController implements Serializable{

    private ScheduleModel eventModel;
    private ScheduleModel lazyEventModel;
    private ScheduleEvent event = new DefaultScheduleEvent();
    private List<Solicitud> solicitudesAprobadas = getSolicitudesAprobadas();
